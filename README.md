...
- **🌐 フロントエンド:** `https://edge-presence-x-mvp-463704.web.app`
- **⚙️ バックエンド:** `https://ep-x-backend-495003035191.asia-northeast1.run.app`

### 📖 使い方ガイド

1.  **アプリケーションにアクセス**
    - 上記の「フロントエンドURL」にアクセスしてください。
...
3.  **フロントエンド (Node.js) のセットアップ**
    ```bash
    # Node.jsの依存関係をインストール
    npm install
    ```

4.  **Google Cloud認証設定 (🔥最重要🔥)**
...
詳しいデプロイ手順については、以下のドキュメントを参照してください。
